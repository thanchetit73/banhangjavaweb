										...
										<div class="col-md-6">
											...
											<div class="form-group">
												<label class="form-control-label">Giá bán</label> <input
													type="number" min="1000" placeholder="Nhập giá" class="form-control"
													name="giagoc">
											</div>
											<div class="form-group">
											...
											<div class="form-actions form-group">
												<button type="submit" class="btn btn-success">Lưu
													lại</button>
												<button type="submit" class="btn btn-danger"name="huy" onclick="history.go(-1);">Hủy
												 bỏ</button>
											</div>
										</div>
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												<label class="form-control-label">Khuyến mãi</label> <input
													type="number" placeholder="Nhập khuyến mãi" min="0" max="100"
